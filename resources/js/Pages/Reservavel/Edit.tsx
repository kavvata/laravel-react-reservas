...
export default function Create({ auth, reservavelJson }: PageProps<{ reservavelJson: string }>) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Editar Reservavel</h2>}
        >
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={submit}>
                            <div className="p-6 space-y-4 text-gray-900 dark:text-gray-100">
                                <div>
                                    <InputLabel htmlFor="nome-reservavel" value="Nome" />
